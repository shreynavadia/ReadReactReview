...
<br> <br>
    ...
    <h1 style="text-align:center;">TIMOHY ZAHN  </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Timothy_Zahn_by_Gage_Skidmore.jpg/1200px-Timothy_Zahn_by_Gage_Skidmore.jpg" alt="wave" height="500"/>
            </div>
