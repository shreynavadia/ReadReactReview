...
<br> <br>
    ...
    <h1 style="text-align:center;">H .G WELLS </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://www.biography.com/.image/t_share/MTE1ODA0OTcxMzI4NzAxOTY1/h-g-wells-39224-1-402.jpg" alt="wave" height="500"/>
            </div>
