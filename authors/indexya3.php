...
<br> <br>
    ...
    <h1 style="text-align:center;"> A Series of Unfortunate Events
                    <small Lemony Snicket </small> </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://images-na.ssl-images-amazon.com/images/I/91JTtfGzbIL.jpg" alt="wave" height="500"/>
            </div>

               <div class="card-description" style="padding-bottom: 100px; padding-left: 100px;" >
               No one can balance absurdity and tragedy quite like Lemony Snicket. His talents are on full display in A Series of Unfortunate Events, thirteen unrelentingly dark yet deliciously readable books about the luckless Baudelaire children. Their troubles begin
                    with their parents’ deaths and their adoption by Count Olaf, the notorious (albeit ridiculous) villain of the series who assumes a new identity in each book — all in pursuit of the Baudelaires’ vast fortune, which always seems just
                    out of reach.
                    <br>
                    <br>
                    <br>
                    ...
                    <a href="https://www.amazon.in/s?k=A+Series+of+Unfortunate+Events+by+Lemony+Snicket&i=stripbooks&ref=nb_sb_noss_2" class="button"> Buy Book</a>
