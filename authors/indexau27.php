...
<br> <br>
    ...
    <h1 style="text-align:center;">LAURA INGALLS </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://www.wxxi.org/sites/default/files/images/pressroom/laura_ingalls_wilder_1937.jpg" alt="wave" height="500"/>
            </div>
