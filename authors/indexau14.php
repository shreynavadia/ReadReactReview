...
<br> <br>
    ...
    <h1 style="text-align:center;">SIDDHARTHA MUKHERJI</h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Siddhartha_Mukherjee.jpg" alt="wave" height="500"/>
            </div>
