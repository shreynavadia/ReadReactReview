...
<br> <br>
    ...
    <h1 style="text-align:center;">CHARLES DICKENS </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://cdn.britannica.com/52/75052-050-777F7105/Charles-Dickens.jpg" alt="wave" height="500"/>
            </div>
