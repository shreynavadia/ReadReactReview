...
<br> <br>
    ...
    <h1 style="text-align:center;">DENNIS LEHANE </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Dennis_Lehane_BBF_2010_Shankbone_crop.jpg/1200px-Dennis_Lehane_BBF_2010_Shankbone_crop.jpg" alt="wave" height="500"/>
            </div>
