...
<br> <br>
    ...
    <h1 style="text-align:center;">SIR ARTHUR CONAN DOYLE </h1>

<div class="cardimage" style="display:flex; align-items:center; padding: 100px; justify-content:space-around;">
            <div class="card__image-holder">

                <img class="card__image" src="https://upload.wikimedia.org/wikipedia/commons/b/bb/Conan_doyle.jpg" alt="wave" height="500"/>
            </div>
